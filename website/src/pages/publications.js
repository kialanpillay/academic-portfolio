              ...
              <Row>
                <Col md="auto" style={{ marginRight: "0rem" }}>
                  <h6 className="publication">
                    ...
                    Peace in Zimbabwean Rural Water Sector. <br />
                  ...
                  <h6 className="publication">
                    ...
                    Livelihoods: Resettlement &amp; Forced Migration. <br />
                  ...
                  <h6 className="publication">
                    ...
                    that? <br />
                    <i>Agenda: Empowering Women for Gender Equity</i>, 29(2),
                    44-53.
                    <a
                      className="pubLink"
                      target="_blank"
                  ...
                  <h6 className="publication">
                    ...
                    within the Global Humanitarian Regime Support. <br />
                  ...
                  <h6 className="publication">
                    ...
                    the Congolese Refugee. <br />
                    <i>Journal of Social Sciences</i>, 45(2), 96-102.
                    <a
                      className="pubLink"
                      target="_blank"
                  ...
                  <h6 className="publication">
                    ...
                    and Narratives of Masculinity. <br />{" "}
                  ...
                  <h6 className="publication">
                    ...
                    Maintaining Self in Migrant Space. <br />
                  ...
                  <h6 className="publication">
                    ...
                    in Wentworth. <br />
                    <i>Journal of Social Sciences</i>, 39(1), 19-30.
                    <a
                      className="pubLink"
                      target="_blank"
                  ...
                  <h6 className="publication">
                    ...
                    "Spectacle"? <br />
                    <i>South Asian Survey</i>, 20(1), 1-13.
                    <a
                      className="pubLink"
                      target="_blank"
                  ...
                  <h6 className="publication">
                    ...
                    Pleasure to Men and Violence to Women. <br />
                  ...
                  <h6 className="publication">
                    ...
                    Migrant Space. <br />
                    <i>The Oriental Anthropologist</i>, 13(1), 35-53.
                    <a
                      className="pubLink"
                      target="_blank"
                  ...
                  <h6 className="publication">
                    ...
                    Humanistic Value of Cancer Narratives. ASnA, <br />
                  ...
                  <h6 className="publication">
                    ...
                    Female Bodies. <br />
                    <i>The Oriental Anthropologist</i>, 11(2), 1-25.{" "}
                    <a
                      className="pubLink"
                      target="_blank"
                  ...
                  <h6 className="publication">
                    ...
                    Consumers. <br />
                    <i>Journal of Social Sciences</i>, 26(1), 29-39.{" "}
                    <a
                      className="pubLink"
                      target="_blank"
